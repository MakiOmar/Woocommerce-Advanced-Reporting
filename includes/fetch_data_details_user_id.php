...
//print_r($ff_columns);
    ...
    if ($pw_detail_view == "yes") {
        ...
        $columns = array(
            ...
            array('lable' => esc_html__('Coupon Discount', __PW_REPORT_WCREPORT_TEXTDOMAIN__), 'status' => 'currency'),
    ...
    foreach ($this->results as $items) {
        ...
        if ($pw_detail_view == "yes") {
            if ($new_order) {
                ...
                $datatable_value .= ("<td style='" . $display_class . "'>");
                $datatable_value .= $order->get_customer_id();
                $datatable_value .= ("</td>");
...
//                    $datatable_value.=("</td>");
    ...
    $pw_detail_view        = $this->pw_get_woo_requests('pw_view_details', "no", true);
    $pw_show_cog           = $this->pw_get_woo_requests('pw_show_cog', 'no', true);
    $table_name_total      = "details_user_id";
    if ($pw_detail_view == "yes") {
